function enviarcorreomasivo() {
  ...
  const elementdiv = document.getElementById("formumensaje");
  elementdiv.classList.add("hidden");
  const elementdiv2 = document.getElementById("enviandomensaje");
  elementdiv2.classList.remove("hidden");
    ...
    if (parseInt(error2.substring(0, 2)) == 20) {
      ...
      if (parseInt(colita) == parseInt(totalaenviar)) {
        ...
        setTimeout(() => {
          ...
          const elementdiv2 = document.getElementById("enviandomensaje");
          elementdiv2.classList.add("hidden");
        }, 3000);
      } else {
        enviar();
      }
